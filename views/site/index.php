                            ...
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                    <div class="productinfo text-center">
                                        ...
                                        <a href="#" class="btn btn-default add-to-cart" data-id="<?=$productItem['id']?>"><i class="fa fa-shopping-cart"></i>В корзину</a>
                                    </div>
...
<!--                                            <img src="--><?php //echo Product::getImage($sliderItem['id']); ?><!--" alt="" />-->
                                            <img src="<?=Product::getImage($sliderItem['id'])  ?>" width="200px" alt="" />
                                            <h2>$<?php echo $sliderItem['price']; ?></h2>
                                            <a href="/product/<?php echo $sliderItem['id']; ?>" style="color: #696763;
                                                     onmouseout="this.style.backgroundColor='#333';" onmouseover="this.style.color='#fdb45e';" onmouseout="this.style.color='#696763';">
